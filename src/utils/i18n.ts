  ...
  en: {
    translation: {
      ...
      checkout: {
        ...
        deliveryAddress: 'Delivery address', email: 'Email address', emailOffers: 'Email me with news and offers', firstName: 'First name', lastName: 'Last name', address: 'Address', apartment: 'Apartment, suite, etc. (optional)', apartmentPlaceholder: 'Apartment, suite, unit, etc.', city: 'City',
        state: 'State / region', postal: 'Postal code', country: 'Country', saveInfo: 'Save this information for next time', smsOffers: 'Text me with news and offers', paymentMethod: 'Payment method', payOnDelivery: 'Cash on delivery', card: 'Credit card', cardholderName: 'Cardholder name', cardholderPlaceholder: 'Name on card', cardNumber: 'Card number', cardExpiry: 'Expiration date', cardCvc: 'Security code',
        shippingText: 'Standard delivery · 2–5 business days', paymentText: 'You will be redirected to the secure payment gateway.', placeOrder: 'Place order', processing: 'Processing…', ready: 'Your checkout details are ready. Payment integration can be connected next.', shippingStandard: 'Standard delivery', cardText: 'Secure card payment through your connected payment gateway.', codText: 'Pay when your order arrives, where available.', agreement: 'By continuing, you agree to fabora’s terms and privacy policy.', errors: { emailError: 'Enter a valid email address.', firstNameError: 'Enter your first name.', lastNameError: 'Enter your last name.', addressError: 'Enter your delivery address.', cityError: 'Enter your city.', countryError: 'Choose your country.', postalError: 'Enter your postal code.', cardholderError: 'Enter the cardholder name.', cardNumberError: 'Enter a valid card number.', cardExpiryError: 'Enter the expiration date.', cardCvcError: 'Enter the security code.' }, signingIn: 'Signing in…'
      },
      auth: {
  ...
  ar: {
    translation: {
      ...
      checkout: {
        ...
        nothing: 'لا يوجد ما يمكن إتمامه', empty: 'حقيبتك فارغة.', emptyText: 'أضف ما يعجبك ثم عد لإكمال طلبك.', contact: 'بيانات التواصل', deliveryAddress: 'عنوان التوصيل', email: 'البريد الإلكتروني', emailOffers: 'أرسل لي الأخبار والعروض عبر البريد الإلكتروني', firstName: 'الاسم الأول', lastName: 'اسم العائلة', address: 'العنوان', apartment: 'الشقة، الجناح، إلخ (اختياري)', apartmentPlaceholder: 'الشقة، الوحدة، رقم الباب، إلخ.', city: 'المدينة', state: 'المحافظة / المنطقة', postal: 'الرمز البريدي', country: 'الدولة', saveInfo: 'احفظ هذه المعلومات للمرة القادمة', smsOffers: 'أرسل لي الأخبار والعروض عبر الرسائل النصية', paymentMethod: 'طريقة الدفع', payOnDelivery: 'الدفع عند الاستلام', card: 'بطاقة ائتمان', cardholderName: 'اسم حامل البطاقة', cardholderPlaceholder: 'الاسم على البطاقة', cardNumber: 'رقم البطاقة', cardExpiry: 'تاريخ الانتهاء', cardCvc: 'رمز الأمان', shippingText: 'توصيل عادي · من 2 إلى 5 أيام عمل', paymentText: 'سيتم تحويلك إلى بوابة الدفع الآمنة.', placeOrder: 'تأكيد الطلب', processing: 'جارٍ المعالجة…', ready: 'بيانات الدفع جاهزة. يمكن ربط بوابة الدفع لاحقًا.', shippingStandard: 'توصيل عادي', cardText: 'دفع آمن بالبطاقة عبر بوابة الدفع المرتبطة.', codText: 'ادفع عند وصول طلبك، حيثما يتوفر ذلك.', agreement: 'بالمتابعة، فإنك توافق على شروط وخصوصية فابورة.', errors: { emailError: 'أدخل بريدًا إلكترونيًا صحيحًا.', firstNameError: 'أدخل اسمك الأول.', lastNameError: 'أدخل اسم العائلة.', addressError: 'أدخل عنوان التوصيل.', cityError: 'أدخل اسم المدينة.', countryError: 'اختر الدولة.', postalError: 'أدخل الرمز البريدي.', cardholderError: 'أدخل اسم حامل البطاقة.', cardNumberError: 'أدخل رقم بطاقة صحيحًا.', cardExpiryError: 'أدخل تاريخ الانتهاء.', cardCvcError: 'أدخل رمز الأمان.' }, signingIn: 'جارٍ تسجيل الدخول…'
      },
      auth: {
