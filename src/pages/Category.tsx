...
import CategoryControlsSection from '../features/category/components/category-controls-section';
import CategoryProductSection from '../features/category/components/category-product-section';
