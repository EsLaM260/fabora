...
export default function CheckoutFormSection({
  ...
  return (
    ...
    >
      ...
      <div className="border-t thin-border pt-7">
        <Button
          type="submit"
        ...
        <p className="text-[10px] text-muted text-center mt-4 leading-5">
  ...
  return (
    <section>
      <div className="flex items-center gap-4 mb-6">
        <div className="w-10 h-10 border thin-border grid place-items-center bg-white rounded-xl">
          {icon}
        </div>
  ...
  return (
    <label className="flex items-start gap-3 cursor-pointer text-sm leading-6">
      <input
        {...register(name)}
        type="checkbox"
        className="mt-1.5 h-4 w-4 accent-black rounded"
      />
  ...
  return (
    ...
    >
      ...
      <span>
        ...
        <span className="block text-xs text-muted leading-5 mt-1">
          {description}
        </span>
      </span>
    </label>
